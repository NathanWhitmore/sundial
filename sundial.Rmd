...
my.file <- eventReactive(input$file1,{
   ...
   my.file <- read_excel(input$file1$datapath, sheet = "Regional Coordinates") 
...
leaflet(options = leafletOptions(zoomControl = FALSE)) %>%
  ...
  addCircleMarkers(
        ...
        fillOpacity = 0.01,
        radius = 10,
        popup =paste(my.file()$`Wetland Complex`, "<br/>",
                     my.file()$District, "<br/>",
                     my.file()$Region)
      ) %>%
         onRender(
...
The code for this dashboard was written by Nathan Whitmore is freely available for reuse and modification via an [MIT license](https://choosealicense.com/licenses/mit/). The source code can be found under the under the '</> Source Code' tab or via [GitHub].  Dashboard creation was funded by the Otago Regional Council. Special thanks go to Scott Jarvie for instigating this project.
